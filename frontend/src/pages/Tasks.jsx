        ...
        <div className="flex flex-wrap gap-2">
          <div className="flex">
            <button
              ...
              className={`px-4 py-2 rounded-l-lg ${viewMode === 'kanban' ? 'bg-blue-600 text-white' : 'glass'}`}
            >
              Kanban
            </button>
            <button
              onClick={() => setViewMode('list')}
              className={`px-4 py-2 rounded-r-lg ${viewMode === 'list' ? 'bg-blue-600 text-white' : 'glass'}`}
            >
              List
            </button>
          </div>
                ...
                {loading ? (
                  ...
                  filteredTasks.map((task) => (
                    <tr key={task.id} className="border-b border-white/10 hover:bg-white/5">
                      <td className="py-3 px-4 font-medium">{task.task}</td>
